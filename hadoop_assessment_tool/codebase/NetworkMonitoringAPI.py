...
class NetworkMonitoringAPI:
    ...
    def get_logs(self):
        ...
        try:
            ...
            remove_list = ["root", "chrony", "ntp","adm","landscape","systemd-journal","utml","syslog"]
            logs = df11[~df11["owner"].isin(remove_list)]
            remove_list_2 = ["alternatives.log","auth.log","fontconfig.log","sysstat","tallylog","audit","btmp"]
