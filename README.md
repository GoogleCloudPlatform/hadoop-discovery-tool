...
## For containerized docker version of the tool, please refer to the README file under discovery-v2 branch to know how to get access to the docker image of the this tool
