...
1. This python-based tool will use **Cloudera API**, **YARN API**, **File system config files** and OS based **CLI** request to retrieve information from the Hadoop cluster
